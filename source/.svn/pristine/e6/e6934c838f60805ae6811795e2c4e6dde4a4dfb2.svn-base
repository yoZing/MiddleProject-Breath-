...
%>
		<tbody>
		  <tr>
		    ...
		    <td><a href="detail.qnaBoard?post_num=<%=boardList.get(i).getPost_num() %>"><%=boardList.get(i).getTitle() %></a></td>
...
<!-- 	<input type="submit" value="글쓰기"> -->
<!-- </form>	 -->
<button type="button" class="btn btn-success btn-sm" id="wbtn" onclick="location.href='Binsert.qnaBoard'">글쓰기</button>
		<br>
